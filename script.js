...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    vi: {
      ...
      ecc1Title: 'Trung Cấp Quản Trị Mạng',
      ecc1Desc: 'Trường Trung cấp Kinh tế Kỹ thuật Vạn Tường (2008–2010). Toàn bộ năng lực thiết kế và Marketing hiện tại đến từ tự học và thực chiến hơn 6 năm.',
      ...
      skillLearningBadge: '<i class="fa-solid fa-book-open"></i> Mới bắt đầu học — chưa dùng trong dự án thực tế',
      skillLearningTools: 'Premiere Pro • Illustrator • Figma',
      ...
      rcCert1Title: 'Trung Cấp Quản Trị Mạng',
      rcCert1Sub: 'Trường TCKTKT Vạn Tường (2008–2010) • Tự học & thực chiến Graphic/Marketing 6+ năm',
    ...
    en: {
      ...
      ecc1Title: 'Vocational Degree in Network Administration',
      ecc1Desc: 'Van Tuong Technical & Economic College (2008–2010). All current Design and Marketing capabilities are developed through self-study and 6+ years of real-world practice.',
      ...
      skillLearningBadge: '<i class="fa-solid fa-book-open"></i> Beginner Level — Not yet used in commercial projects',
      skillLearningTools: 'Premiere Pro • Illustrator • Figma',
      ...
      rcCert1Title: 'Vocational Degree in Network Administration',
      rcCert1Sub: 'Van Tuong College (2008–2010) • Self-taught & 6+ yrs hands-on Graphic/Marketing',
  ...
  const caseStudiesData = {
    ...
    'nla-profile': {
      ...
      tools: 'Adobe InDesign, Photoshop, Kỹ thuật thiết kế Print Ready CMYK, Xử lý ảnh chụp kho hàng & hệ thống pallet.',
    ...
    'tiasang-telecom': {
      ...
      tools: 'Adobe Photoshop, InDesign, CorelDRAW, Quy chuẩn thiết kế kỹ thuật Print-Ready CMYK, Xử lý hình ảnh công trình thực tế & sơ đồ kiến trúc hệ thống mạng SI.',
